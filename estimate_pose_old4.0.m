function [A, pos, q] = estimate_pose(sensor, varargin)
...
%         coord_img_p0 = sensor.p0 ./ vecnorm([sensor.p0; ones(1, size(sensor.id, 2))]);
%         coord_img_p1 = sensor.p1 ./ vecnorm([sensor.p1; ones(1, size(sensor.id, 2))]);
%         coord_img_p2 = sensor.p2 ./ vecnorm([sensor.p2; ones(1, size(sensor.id, 2))]);
%         coord_img_p3 = sensor.p3 ./ vecnorm([sensor.p3; ones(1, size(sensor.id, 2))]);
%         coord_img_p4 = sensor.p4 ./ vecnorm([sensor.p4; ones(1, size(sensor.id, 2))]);
...
%         coord_img_p0 = K\[sensor.p0; ones(1, size(sensor.id, 2))];
%         coord_img_p1 = K\[sensor.p1; ones(1, size(sensor.id, 2))];
%         coord_img_p2 = K\[sensor.p2; ones(1, size(sensor.id, 2))];
%         coord_img_p3 = K\[sensor.p3; ones(1, size(sensor.id, 2))];
%         coord_img_p4 = K\[sensor.p4; ones(1, size(sensor.id, 2))];

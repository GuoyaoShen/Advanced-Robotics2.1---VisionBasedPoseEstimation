...
if sensor.is_ready
    if size(sensor.id) == 0  % No id capture
        pos = zeros(3,0);
        q = zeros(4,0);
        return
       ...
       %% Compute matrix A
        ...
        pt_col = floor((sensor.id+1) ./ 12)+1;  % 1xN, column num
        ...
        for n = 1: size(sensor.id, 2)
            A(10*(n-1)+1:10*n, :) = ...
                [coord_world_p0(1,n), coord_world_p0(2,n), 1, 0, 0, 0, -sensor.p0(1,n)*coord_world_p0(1,n), -sensor.p0(1,n)*coord_world_p0(2,n), -sensor.p0(1,n);
                 0, 0, 0, coord_world_p0(1,n), coord_world_p0(2,n), 1, -sensor.p0(2,n)*coord_world_p0(1,n), -sensor.p0(2,n)*coord_world_p0(2,n), -sensor.p0(2,n);
                 
                 coord_world_p1(1,n), coord_world_p1(2,n), 1, 0, 0, 0, -sensor.p1(1,n)*coord_world_p1(1,n), -sensor.p1(1,n)*coord_world_p1(2,n), -sensor.p1(1,n);
                 0, 0, 0, coord_world_p1(1,n), coord_world_p1(2,n), 1, -sensor.p1(2,n)*coord_world_p1(1,n), -sensor.p1(2,n)*coord_world_p1(2,n), -sensor.p1(2,n);
                 
                 coord_world_p2(1,n), coord_world_p2(2,n), 1, 0, 0, 0, -sensor.p2(1,n)*coord_world_p2(1,n), -sensor.p2(1,n)*coord_world_p2(2,n), -sensor.p2(1,n);
                 0, 0, 0, coord_world_p2(1,n), coord_world_p2(2,n), 1, -sensor.p2(2,n)*coord_world_p2(1,n), -sensor.p2(2,n)*coord_world_p2(2,n), -sensor.p2(2,n);
                 
                 coord_world_p3(1,n), coord_world_p3(2,n), 1, 0, 0, 0, -sensor.p3(1,n)*coord_world_p3(1,n), -sensor.p3(1,n)*coord_world_p3(2,n), -sensor.p3(1,n);
                 0, 0, 0, coord_world_p3(1,n), coord_world_p3(2,n), 1, -sensor.p3(2,n)*coord_world_p3(1,n), -sensor.p3(2,n)*coord_world_p3(2,n), -sensor.p3(2,n);
                 
                 coord_world_p4(1,n), coord_world_p4(2,n), 1, 0, 0, 0, -sensor.p4(1,n)*coord_world_p4(1,n), -sensor.p4(1,n)*coord_world_p4(2,n), -sensor.p4(1,n);
                 0, 0, 0, coord_world_p4(1,n), coord_world_p4(2,n), 1, -sensor.p4(2,n)*coord_world_p4(1,n), -sensor.p4(2,n)*coord_world_p4(2,n), -sensor.p4(2,n);];
        end
